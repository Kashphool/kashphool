        ...
        <div className="container relative z-10 grid items-center gap-14 lg:grid-cols-[0.82fr_1.18fr] lg:gap-20 xl:grid-cols-[0.72fr_1.28fr]">
          <div className="relative mx-auto flex h-64 w-full max-w-xl items-center justify-center sm:h-80 lg:h-96 xl:h-[28rem]">
            ...
            >
              <span
                aria-hidden="true"
                className="font-[var(--font-display)] text-[8rem] font-bold leading-none text-gold-gradient sm:text-[11rem] lg:text-[13rem] xl:text-[15rem]"
              >
                4
              </span>
              <div
                aria-hidden="true"
                className="relative -mx-2 flex h-24 w-24 shrink-0 items-center justify-center rounded-full border border-gold/40 bg-charcoal-light p-2 shadow-2xl shadow-saffron/15 sm:-mx-3 sm:h-32 sm:w-32 sm:p-3 lg:h-36 lg:w-36 xl:h-40 xl:w-40"
              >
          ...
          <div className="mx-auto max-w-xl text-center lg:mx-0 lg:pl-10 lg:text-left xl:pl-16">
            <span className="text-sm font-semibold uppercase tracking-[0.3em] text-saffron/80">
              {notFoundPageContent.eyebrow}
            </span>
            <h1 className="mt-4 font-[var(--font-display)] text-4xl font-bold leading-tight md:text-6xl">
              {notFoundPageContent.headingPrefix}{" "}
              <span className="text-gold-gradient">
                {notFoundPageContent.headingAccent}
              </span>
            </h1>
            ...
            <div className="mt-9 flex flex-col justify-center gap-4 sm:flex-row lg:justify-start">
              <a
                href="/"
                className="inline-flex items-center justify-center gap-2 rounded bg-gradient-to-r from-saffron to-gold px-7 py-3.5 font-semibold text-charcoal transition-all hover:scale-[1.02] hover:shadow-lg hover:shadow-saffron/20"
              >
                <ArrowLeft aria-hidden="true" size={18} />{" "}
                {notFoundPageContent.homeLabel}
              </a>
              <a
                href="/#contact"
                className="inline-flex items-center justify-center gap-2 rounded border border-gold/30 px-7 py-3.5 font-semibold text-gold transition-colors hover:bg-gold/10"
              >
                <Mail aria-hidden="true" size={18} />{" "}
                {notFoundPageContent.contactLabel}
              </a>
            </div>
            ...
            <div className="mt-12 flex items-center justify-center gap-4 text-xs uppercase tracking-[0.2em] text-ivory/25 lg:justify-start">
              ...
              {notFoundPageContent.identityLine}
